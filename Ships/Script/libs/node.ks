function node_exec {
    ...
    debugMessage("eta:" + round(nd:eta) + ", dV: " + round(nd:deltav:mag,2) + ", dT: " + round(burn_duration)).
    ...
    local v is nd:burnvector.
    debugMessage("begin burn: " + round(nd:deltav:mag,2) + " m/s").
    ...
    debugMessage("end burn, error:"+round(nd:deltaV:mag,2)+"m/s").
